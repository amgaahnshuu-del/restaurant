...
const team = [
  { image: chef1, name: "Б. Батболд", role: "Ерөнхий тогооч", desc: "15 жилийн олон улсын туршлагатай, Франц, Японд суралцсан" },
...
const TeamSection = () => {
  return (
    <section className="py-32 px-8 lg:px-16 bg-card">

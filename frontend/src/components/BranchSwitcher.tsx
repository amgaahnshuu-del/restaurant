    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-4 py-3">
        <div className="flex items-center justify-center gap-2">
          <span className="hidden font-sans text-[10px] uppercase tracking-[0.24em] text-muted-foreground/60 sm:inline">
            {copy.label}
          </span>
          ...
          return (
            <button
              ...
              className={`rounded-full border px-4 py-2 font-sans text-[10px] uppercase tracking-[0.18em] transition-all duration-300 sm:text-[11px] ${
                isActive
